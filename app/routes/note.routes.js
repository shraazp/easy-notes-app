...
// Create a new Note
router.post('/', validation.upload.single('profileImg'),validation.authenticateJWT,validation.validate, notes.create);
// Retrieve all Notes
router.get('/', validation.authenticateJWT,notes.findAll);
// Retrieve a single Note with noteId
router.get('/:noteId',validation.authenticateJWT, notes.findOne);
// Update a Note with noteId
router.put('/:noteId', validation.upload.single('profileImg'),validation.authenticateJWT,validation.validate, notes.update);
